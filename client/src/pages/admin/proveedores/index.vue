    ...
    <div>
        ...
        >
            <q-card class="modales" style="width: 500px !important;" color="primary">
                ...
                <q-card-section class="area_comment">                   
					<q-input  dense standout required label='Proveedor' v-model='nuevo_proveedor' class="input-reg q-mx-lg">
					</q-input>
                    <q-input  dense standout required label='Dirección' v-model='nuevo_direccion' class="input-reg q-mx-lg">
					</q-input>
                    ...
                    <q-input  dense standout required label='Categoría' v-model='nuevo_categoria' class="input-reg q-mx-lg">
					</q-input>
        ...
        >
            <q-card class="modales" style="width: 500px !important;">
                ...
                <q-card-section class="area_comment">                      
                    <q-input  dense standout required label='Proveedor' v-model='editar_proveedor' class="input-reg q-mx-lg">
                    </q-input>
                    <q-input  dense standout required label='Dirección' v-model='editar_direccion' class="input-reg q-mx-lg">
                    </q-input>
                    ...
                    <q-input  dense standout required label='Categoría' v-model='editar_categoria' class="input-reg q-mx-lg">
                    </q-input>
