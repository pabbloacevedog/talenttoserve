<template>
    ...
    >
        ...
        <template  v-slot:body="props" >
            <q-tr :props="props" v-on:dblclick="funciones.editar_fila(props.row.id_unidad_medida)">
                <q-td auto-width>
                    <q-checkbox size="sm"  color="accent" v-model="props.selected"/>
                </q-td>
                <q-td key="unidad_base" :props="props">{{ props.row.unidad_base }}  ({{props.row.nombre}})</q-td>
                <q-td key="unidad_conversion" v-if="props.row.unidad_conversion" :props="props">{{ props.row.unidad_conversion.toFixed(4) }}  ({{parametros.unidad_base}})</q-td>
                <q-td key="unidad_conversion" v-else :props="props">{{ props.row.unidad_conversion }}  ({{parametros.unidad_base}})</q-td>
                <q-td key="nombre" :props="props">{{ props.row.nombre }}</q-td>
                <q-td key="descripcion" :props="props">{{ props.row.descripcion }}</q-td>
                <q-td key="acronimo" :props="props">{{ props.row.acronimo }}</q-td>
