...
(function() {
    ...
    function Sa(a) {
        if (!Ma) {
            ...
            "undefined" === typeof ca.Chart.creditHref ? (a.creditHref = "",
                a.creditText = "") : (c = a.updateOption("creditText"), b = a.updateOption("creditHref"));
    ...
    function y(a, c) {
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas = ga(d, f);
            this.canvas.style.width = "100%"; //ER
    ...
    var I = {},
        ...
        ca = {
            ...
            CultureInfo: {
                ...
                panText: "Pan",
                resetText: "Reset",
                menuText: "Más Optiones",
                saveJPGText: "Guardar como JPEG",
                savePNGText: "Guardar como PNG",
                printText: "Imprimir",
                days: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
                shortDays: "Sun Mon Tue Wed Thu Fri Sat".split(" "),
                months: "January February March April May June July August September October November December".split(" "),
                shortMonths: "Ene Feb Mar Abr May Jun Jul Aug Sep Oct Nov Dic".split(" ")
            }
        },
        pa = {
            en: {}
